...
import "highlight.js/styles/default.css"; // CSS theme cho highlight.js
...
class ImageBlot extends BlockEmbed {
  static create(value) {
    ...
    if (typeof value === "object") {
      ...
      if (value.alt) imgTag.setAttribute("alt", value.alt);
      if (value.class) imgTag.setAttribute("class", value.class);
    } else {
...
class VideoBlot extends BlockEmbed {
  static create(value) {
    ...
    //   videoTag.setAttribute("controls", ""); // Video thông thường
    //   return videoTag;
    // } else if (typeof value === "string" && value.includes("youtube.com")) {
    //   const iframeTag = document.createElement("iframe");
    //   iframeTag.setAttribute("src", value);
    //   iframeTag.setAttribute("frameborder", "0");
    //   iframeTag.setAttribute("allowfullscreen", true);
    //   iframeTag.setAttribute("width", "100%");
    //   return iframeTag; // Nhúng iframe (YouTube, Vimeo)
    // }
...
class QuillEditor extends React.Component {
  ...
  insertImage = (e) => {
    ...
    if (
      ...
      axios.post("/api/v1/uploadFiles", formData, config).then((response) => {
  ...
  insertVideo = (e) => {
    ...
    if (
      ...
      axios
        .post("/api/v1/uploadVideos", formData, config)
        .then((response) => {
  ...
  modules = {
    // syntax: true,
    // thêm cấu hình syntax sau nếu gặp lỗi  Syntax module requires highlight.js. Please include the library
    // syntax: {
